...
end, { desc = 'Go to Implementation (new tab)' })
...
vim.g.netrw_banner = 0 -- убирает огромный баннер сверху
vim.g.netrw_liststyle = 3 -- древовидный вид (как в современных IDE)
vim.g.netrw_browse_split = 0
vim.keymap.set('n', '|', ':Vex<CR>')
vim.keymap.set('n', '_', ':Sex<CR>')
